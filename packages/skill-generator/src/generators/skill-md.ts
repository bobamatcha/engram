...
export function generateSkillMarkdown(
  ...
  lines.push('');
  lines.push(
    `*Generated by [engram](https://github.com/bobamatcha/engram) on ${new Date().toISOString().split('T')[0]}*`
  );
...
// Helper function
function groupLearningsByCategory(learnings: Learning[]): Record<string, Learning[]> {
