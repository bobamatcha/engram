/**
 * Core types for @4meta5/skill-generator
 */
...
// ============================================================================
// Trigger Recognition Types (from claudeception patterns)
// ============================================================================

/** Trigger signal types */
export type TriggerSignalType =
  | 'error-resolution'        // Error → investigation → fix pattern
  | 'non-obvious-discovery'   // >10 min investigation, not in docs
  | 'architectural-decision'  // Explicit design choice
  | 'convention-establishment'// Project norm discovered
  | 'workaround-discovery';   // Tool/framework limitation bypass
